...
TEST(ReconstructItenaryTests, LCTEST) {
    ...
    vector<pair<string,string>> itenerary={{"INN","CBR"},{"AXA","ADL"},{"HBA","SYD"},{"CBR","INN"},{"AUA","MEL"},{"CBR","ADL"},{"PER","LST"},{"OOL","HBA"},{"LST","SYD"},{"EZE","LST"},{"HBA","EZE"},{"MEL","LST"},{"INN","CNS"},{"ADL","INN"},{"BNE","MEL"},{"AXA","CBR"},{"CNS","OOL"},{"LST","AXA"},{"AXA","CBR"},{"HBA","CBR"},{"JFK","EZE"},{"AUA","EZE"},{"CBR","AXA"},{"LST","BNE"},{"AUA","BIM"},{"AUA","MEL"},{"CBR","HBA"},{"AXA","LST"},{"PER","ANU"},{"ANU","AUA"},{"SYD","PER"},{"MEL","PER"},{"CBR","MEL"},{"BNE","AUA"},{"LST","CBR"},{"EZE","AUA"},{"LST","PER"},{"MEL","BNE"},{"PER","AXA"},{"EZE","HBA"},{"MEL","AUA"},{"SYD","AXA"},{"ADL","LST"}};
    auto ans=r.findItinerary(itenerary);
    vector<string> expAns={"JFK","EZE","AUA","EZE","HBA","CBR","ADL","INN","CBR","AXA","ADL","LST","AXA","CBR","HBA","EZE","LST","BNE","AUA","MEL","AUA","MEL","BNE","MEL","LST","CBR","INN","CNS","OOL","HBA","SYD","AXA","CBR","MEL","PER","AXA","LST","PER","LST","SYD","PER","ANU","AUA","BIM"};
    ASSERT_THAT(ans, ::testing::ContainerEq(expAns));
}
...
TEST(ReconstructItenaryTests, LCTEST2) {
    ...
    vector<string> expAns={"JFK","EZE","MEL","EZE","PER","AXA","ADL","DRW","AUA","DRW","AUA","MEL","PER","ANU","EZE","SYD","CBR","EZE","TBI"};
    ASSERT_THAT(ans, ::testing::ContainerEq(expAns));
}